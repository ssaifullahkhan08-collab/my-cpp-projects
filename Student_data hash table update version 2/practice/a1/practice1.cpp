...
public:
    ...
    void DisplayUser(User role)
    {
        if (role == User::Student)
        {
            ...
            cout << setw(4) << left << "ID" << setw(15) << left << "Name" << setw(25) << left << "Gmail" << setw(15) << left << "Password" << setw(40) << left << "Department" << setw(25) << left << "Program" << setw(10) << left << "Semester" << setw(5) << left << "GPA" << endl;
        }
        else if (role == User::Teacher)
        {
            cout << "----------------------------------All Teacher Data---------------------------------\n";
            cout << setw(4) << left << "ID" << setw(15) << left << "Name" << setw(25) << left << "Gmail" << setw(15) << left << "Password" << setw(40) << left << "Department" << setw(25) << left << "Program" << setw(8) << left << "Salary" << endl;
        }
        ...
        for (auto &u : data)
        {
            cout << "-----------------------------------------------------------------------------------------------------------------------------------------------\n";
            if (role == User::Student)
                cout << setw(4) << left << u.id << setw(15) << left << u.name << setw(25) << left << u.gmail << setw(15) << left << u.password << setw(40) << left << u.department << setw(25) << left << u.program << setw(10) << left << u.semester << setw(5) << left << u.gpa << endl;
            else if (role == User::Teacher)
                cout << setw(4) << left << u.id << setw(15) << left << u.name << setw(25) << left << u.gmail << setw(15) << left << u.password << setw(40) << left << u.department << setw(25) << left << u.program << setw(8) << left << u.sallary << endl;
        }
    }
    ...
    //     vector<string> UpdatingMenu;
    //     stringstream ss(option);
    //     string temp;
    //     getline(ss, temp, ',');
    //     UpdatingMenu[0] = "Department";
    //     UpdatingMenu[1] = "Program";
    //     if (role == User::Student)
    //     {
    //         UpdatingMenu[2] = "Semester";
    //         UpdatingMenu[3] = "Gpa";
    //     }
    //     else if (role == User::Teacher)
    //     {
    //         UpdatingMenu[2] = "Sallary";
    //     }
    // }
    ...
    void ForgotPassword(filePath type, User Role, string gmail, string name)
    {
        ...
        for (auto &u : data)
        {
            if (u.gmail == gmail && u.name == name)
            {
                ...
                u.password = newpassword;
                SaveData(type, Role);
                cout << "Forgot Password Successfully:\nLogin again with new cridential\n";
                return;
            }
    ...
    do
    {
        ...
        case Menu::LoginAccount:
            ...
            if (IsValidGmail(Gmail))
            {
                ...
                {
                    Password = SafeString("Enter Password: ");
